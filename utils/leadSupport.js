...
const formatLeadForApi = (lead) => {
  ...
  return {
    ...
    createdBy: buildAssignedAdminPayload(base.createdBy),
    ...
    statusUpdatedBy: buildAssignedAdminPayload(base.statusUpdatedBy),
    statusUpdatedAt: base.statusUpdatedAt || null,
    assignmentState,
